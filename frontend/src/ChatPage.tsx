...
export function ChatPage({ onLogout }: { onLogout: () => void; }) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="bg-white rounded-xl shadow-lg flex-1 flex flex-col max-w-4xl mx-auto w-full overflow-hidden min-h-0">
        <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-xl flex items-center justify-between">
