                                    ...
                                    <div className="max-h-48 overflow-y-auto">
                                        {categories
                                            ...
                                            >
                                                ...
                                                name="category" 
                                                value={cat}
                                                checked={editedProduct.category[0] === cat} 
                                                onChange={() => handleInputChange('categories', [cat])}
...
const handleSaveEditModal = async (editedProduct: EditProduct) => {
  ...
  formData.append("categories", editedProduct.category ?? "");
  ...
  handleCloseEditModal();
    ...
    const handleDeleteProduct = async (product: Product) => {
        await fetch_with_auth.post('delete_item/', { item_id: product.id});
