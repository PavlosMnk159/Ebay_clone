...
function BidExtraModal({ product, amount, isOpen, onClose, onDataChange }: BidOfferModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            try {
                await fetch_with_auth.post('bid/', request_data);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'buy') {
                ...
                try {
                    await fetch_with_auth.post('buy', request_data);
...
export function EBayPage({isAdmin, isGuest, onLogout } : {isAdmin : boolean; isGuest : boolean; onLogout: () => void;}){
    ...
    const applyFilters = async () => {
        try {
            ...
            if (key === "category" && value.toLowerCase() === "none") return false;
            return true;
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 py-6">
                <div className="flex gap-6">
                    ...
                    <div className="w-64 bg-white rounded-lg shadow-sm p-6 h-fit space-y-2">
